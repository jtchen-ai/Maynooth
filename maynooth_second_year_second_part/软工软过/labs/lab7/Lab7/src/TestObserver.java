...
public class TestObserver {
	...
	public static void main(String[] args) {
		...
		// Testing the new commercial feature as required by Exercise 3.
		commercial commercialObject = (commercial) subject;
		commercialObject.setCommertical("Commercial Break: Enjoy a refreshing drink!");
